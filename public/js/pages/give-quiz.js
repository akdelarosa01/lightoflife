...
/***/ "./resources/js/pages/give-quiz.js":
/*!*****************************************!*\
  !*** ./resources/js/pages/give-quiz.js ***!
  \*****************************************/
/*! no exports provided */
...
function sections(_x, _x2) {
  return _sections.apply(this, arguments);
}

function _sections() {
  _sections = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(subject_id, section_id) {
    var option;
...
function quizzes(_x3, _x4) {
  return _quizzes.apply(this, arguments);
}

function _quizzes() {
  _quizzes = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(subject_id, quiz_id) {
    var option;
...
function getQuizzes() {
  return _getQuizzes.apply(this, arguments);
}

function _getQuizzes() {
  _getQuizzes = _asyncToGenerator(
  /*#__PURE__*/
  ...
  $('#tbl_quizzes').dataTable({
    ...
    columns: [{
      data: function data(_data) {
        return '<input type="checkbox" class="check_quiz" value="' + _data.quiz_id + '">';
      },
      searchable: false,
      orderable: false
    }, {
      data: function data(_data2) {
        return '<button class="btn btn-sm btn-primary btn_edit_quiz" data-id="' + _data2.quiz_id + '"' + 'data-section_id="' + _data2.section_id + '"' + 'data-subject_id="' + _data2.subject_id + '"' + 'data-quiz_title="' + _data2.quiz_title + '"' + 'data-quiz_type="' + _data2.quiz_type + '"' + 'data-start_date="' + _data2.start_date + '"' + 'data-start_time="' + _data2.start_time + '"' + 'data-due_date="' + _data2.due_date + '"' + 'data-due_time="' + _data2.due_time + '"' + 'data-timer="' + _data2.timer + '"' + 'data-max_attempt="' + _data2.max_attempt + '"' + 'data-instruction="' + _data2.instruction + '"' + 'data-late_submission="' + _data2.late_submission + '"' + '>' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 24:
/*!***********************************************!*\
  !*** multi ./resources/js/pages/give-quiz.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\give-quiz.js */"./resources/js/pages/give-quiz.js");
