...
/***/ "./resources/js/pages/handouts.js":
/*!****************************************!*\
  !*** ./resources/js/pages/handouts.js ***!
  \****************************************/
/*! no exports provided */
  ...
  $('#tbl_class').dataTable({
    ...
    columns: [{
      ...
      data: function data(_data) {
        return '<button class="btn btn-sm btn-primary btn_view_handouts" ' + 'data-program="' + _data.program + '"' + 'data-program_id="' + _data.program_id + '"' + 'data-subject="' + _data.subject + '"' + 'data-subject_id="' + _data.subject_id + '"' + 'data-section="' + _data.section + '"' + 'data-section_id="' + _data.section_id + '">' + '<i class="fa fa-eye"></i>' + '</button>';
      }
    }]
  });
}

function getHandouts(_x, _x2, _x3) {
  return _getHandouts.apply(this, arguments);
}

function _getHandouts() {
  _getHandouts = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(section_id, subject_id, program_id) {
  ...
  $('#tbl_handouts').dataTable({
    ...
    columns: [{
      data: function data(_data2) {
        return '<input type="checkbox" class="check_handout" value="' + _data2.id + '">';
      },
      searchable: false,
      orderable: false
    }, {
      data: function data(_data3) {
        return '<a href="/' + _data3.file_path + '" class="btn btn-sm btn-primary" target="_blank">' + '<i class="fa fa-eye"></i>' + '</a>' + '<a href="/' + _data3.file_path + '" download class="btn btn-sm btn-info">' + '<i class="fa fa-download"></i>' + '</a>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 4:
/*!**********************************************!*\
  !*** multi ./resources/js/pages/handouts.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\handouts.js */"./resources/js/pages/handouts.js");
