...
/***/ "./resources/js/pages/item_analysis.js":
/*!*********************************************!*\
  !*** ./resources/js/pages/item_analysis.js ***!
  \*********************************************/
...
$(function () {
  ...
  $('#tbl_quiz_body').on('click', '.btn_view_grade', function () {
    ...
    $.ajax({
      url: '../../activities/get-quiz-analysis-details',
      type: 'GET',
      dataType: 'JSON',
      data: {
...
function getQuizzes() {
  $('.loading').show();
  $.ajax({
    url: '../../activities/get-given-quiz-analysis',
    type: 'GET',
    dataType: 'JSON'
  }).done(function (data, textStatus, xhr) {
    QuizzesTable(data);
...
/***/ 22:
/*!***************************************************!*\
  !*** multi ./resources/js/pages/item_analysis.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\item_analysis.js */"./resources/js/pages/item_analysis.js");
