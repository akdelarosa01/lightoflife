...
/***/ "./resources/js/pages/accounts.js":
/*!****************************************!*\
  !*** ./resources/js/pages/accounts.js ***!
  \****************************************/
/*! no exports provided */
  ...
  $('#tbl_account').dataTable({
    ...
    columns: [{
      data: function data(_data) {
        return '<input type="checkbox" class="check_account" value="' + _data.id + '">';
      },
      searchable: false,
      orderable: false
    }, {
      data: function data(_data2) {
        return '<button class="btn btn-sm btn-primary btn_edit_account" ' + 'data-id="' + _data2.id + '" ' + 'data-username="' + _data2.username + '" ' + 'data-firstname="' + _data2.firstname + '" ' + 'data-middlename="' + _data2.middlename + '" ' + 'data-lastname="' + _data2.lastname + '" ' + 'data-program="' + _data2.program + '" ' + 'data-department="' + _data2.department + '" ' + 'data-user_type="' + _data2.user_type + '" >' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
      ...
      data: function data(_data3) {
        if (_data3.user_type == 1) {
          return 'Administrator';
        }

        if (_data3.user_type == 2) {
          return 'Teacher';
        }

        if (_data3.user_type == 3) {
          return 'Student';
        }
      }
    }, {
...
/***/ 9:
/*!**********************************************!*\
  !*** multi ./resources/js/pages/accounts.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\accounts.js */"./resources/js/pages/accounts.js");
