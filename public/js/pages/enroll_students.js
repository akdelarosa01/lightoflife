...
/***/ "./resources/js/pages/enroll_students.js":
/*!***********************************************!*\
  !*** ./resources/js/pages/enroll_students.js ***!
  \***********************************************/
/*! no exports provided */
...
$(function () {
  ...
  $('#tbl_enrolled_body').on('click', '.btn_edit_enrolled', function () {
    ...
    $('#program').val($(this).attr('data-program')); //$('#section').val($(this).attr('data-section'));
...
function getEnrolled() {
  return _getEnrolled.apply(this, arguments);
}

function _getEnrolled() {
  _getEnrolled = _asyncToGenerator(
  /*#__PURE__*/
  ...
  $('#tbl_enrolled').dataTable({
    ...
    columns: [{
      ...
      data: function data(_data) {
        return '<button class="btn btn-sm btn-primary btn_edit_enrolled"' + 'data-id="' + _data.id + '"' + 'data-program="' + _data.program_id + '"' + 'data-section="' + _data.section_id + '"' + 'data-school_year="' + _data.school_year + '"' + 'data-no_of_students="' + _data.no_of_students + '">' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }]
...
function getSubjects(_x) {
  return _getSubjects.apply(this, arguments);
}

function _getSubjects() {
  _getSubjects = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(prog_id) {
...
function getStudents(_x2, _x3) {
  return _getStudents.apply(this, arguments);
}

function _getStudents() {
  _getStudents = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(prog_id, sec_id) {
  ...
  $('#tbl_students').dataTable({
    ...
    columns: [{
      data: function data(_data2) {
        ...
        if (_data2.section_id > 0) {
          checked = 'checked';
        }

        return '<input type="checkbox" class="check_student" name="student_user_id[]" value="' + _data2.id + '" ' + checked + '>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 18:
/*!*****************************************************!*\
  !*** multi ./resources/js/pages/enroll_students.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\enroll_students.js */"./resources/js/pages/enroll_students.js");
