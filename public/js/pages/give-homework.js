...
/***/ "./resources/js/pages/give-homework.js":
/*!*********************************************!*\
  !*** ./resources/js/pages/give-homework.js ***!
  \*********************************************/
/*! no exports provided */
...
function homeworks(_x3, _x4) {
  return _homeworks.apply(this, arguments);
}

function _homeworks() {
  _homeworks = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(subject_id, hw_id) {
    var option;
  ...
  $('#tbl_homeworks').dataTable({
    ...
    columns: [{
      ...
      data: function data(_data2) {
        return '<button class="btn btn-sm btn-primary btn_edit_homework"' + 'data-hw_given_id="' + _data2.id + '" ' + 'data-subject="' + _data2.subject_id + '" ' + 'data-due_date="' + _data2.due_date + '" ' + 'data-due_time="' + _data2.due_time + '" ' + 'data-section_id="' + _data2.section_id + '"' + 'data-hw_id="' + _data2.hw_id + '"' + 'data-title="' + _data2.title + '">' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 25:
/*!***************************************************!*\
  !*** multi ./resources/js/pages/give-homework.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\give-homework.js */"./resources/js/pages/give-homework.js");
