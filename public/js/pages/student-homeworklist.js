...
/***/ "./resources/js/pages/student-homeworklist.js":
/*!****************************************************!*\
  !*** ./resources/js/pages/student-homeworklist.js ***!
  \****************************************************/
/*! no exports provided */
...
function getHomeworkDetails(_x) {
  return _getHomeworkDetails.apply(this, arguments);
}

function _getHomeworkDetails() {
  _getHomeworkDetails = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(hw_id) {
...
function getHomeworkAnswer(_x2) {
  return _getHomeworkAnswer.apply(this, arguments);
}

function _getHomeworkAnswer() {
  _getHomeworkAnswer = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(hw_id) {
  ...
  $('#tbl_pending').dataTable({
    ...
    columns: [{
      data: function data(_data) {
        return '<button class="btn btn-sm btn-primary btn_answer_hw" data-id="' + _data.id + '" ' + 'data-hw_id="' + _data.hw_id + '"' + '>' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
  ...
  $('#tbl_finished').dataTable({
    ...
    columns: [{
      data: function data(_data2) {
        return '<button class="btn btn-sm btn-primary btn_view_answer" data-id="' + _data2.id + '" ' + 'data-hw_id="' + _data2.hw_id + '"' + '>' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 29:
/*!**********************************************************!*\
  !*** multi ./resources/js/pages/student-homeworklist.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\student-homeworklist.js */"./resources/js/pages/student-homeworklist.js");
