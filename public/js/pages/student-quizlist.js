...
/***/ "./resources/js/pages/student-quizlist.js":
/*!************************************************!*\
  !*** ./resources/js/pages/student-quizlist.js ***!
  \************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $('#take_quiz').on('click', function () {
    window.location.href = '../../student-activities/take-quiz?quiz_id=' + $('#quiz_id').val();
  });
  $('#tbl_finished_body').on('click', '.btn_view_results', function () {
    $.ajax({
      url: '../../student-activities/view-quiz-results',
      type: 'GET',
      dataType: 'JSON',
      data: {
      ...
      var qg_results = data.qg_results == undefined ? [] : data.qg_results;
      ...
      $.each(qg_item, function (i, x) {
        ...
        items += '<tr>' + '<td colspan="2">' + x.question_num + '. ' + x.question + '</td>' + '<td>Your Answer is: ' + x.student_answer + '</td>' + '<td>Score: ' + x.score + ' out of ' + x.max_score + '</td>' + '</tr>';
      });
...
function getQuizDetails(id) {
  $('.loading').show();
  $.ajax({
    url: '../../student-activities/get-quiz-details',
    type: 'GET',
    dataType: 'JSON',
    data: {
      quiz_id: id
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return $.ajax({
              url: '../../student-activities/get-pending-quizzes',
              type: 'GET',
              dataType: 'JSON'
            }).done(function (data, textStatus, xhr) {
              PendingTable(data);
  ...
  $('#tbl_pending').dataTable({
    ...
    columns: [{
      data: function data(_data) {
        return '<button class="btn btn-sm btn-primary btn_check_quiz" data-quiz_id="' + _data.quiz_id + '">' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
function getFinished() {
  return _getFinished.apply(this, arguments);
}

function _getFinished() {
  _getFinished = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return $.ajax({
              url: '../../student-activities/get-finished-quizzes',
              type: 'GET',
              dataType: 'JSON'
            }).done(function (data, textStatus, xhr) {
              FinishedTable(data);
  ...
  $('#tbl_finished').dataTable({
    ...
    columns: [{
      data: function data(_data2) {
        return '<button class="btn btn-sm btn-primary btn_view_results" data-quiz_id="' + _data2.quiz_id + '"' + 'data-qg_id="' + _data2.id + '"' + 'data-subject_id="' + _data2.subject_id + '"' + 'data-section_id="' + _data2.section_id + '"' + 'data-subject="' + _data2.subject + '"' + 'data-quiz_title="' + _data2.quiz_title + '"' + 'data-status="' + _data2.status + '"' + 'data-student_id="' + _data2.student_id + '"' + 'data-teacher_id="' + _data2.teacher_id + '"' + 'data-date_submitted="' + _data2.date_submitted + '"' + '>' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
/***/ 28:
/*!******************************************************!*\
  !*** multi ./resources/js/pages/student-quizlist.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\lightoflife2019\resources\js\pages\student-quizlist.js */"./resources/js/pages/student-quizlist.js");
