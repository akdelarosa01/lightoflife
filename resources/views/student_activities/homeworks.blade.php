    ...
    <div class="row">
        <div class="offset-md-2 col-md-8">
            <div class="card shadow-lg">
                <div class="card-header bg-red text-white">Homeworks</div>
...
@include('modals.modal_student_homework')
@endsection

@push('scripts')
<script type="text/javascript" src="{{ asset('/js/pages/student-homeworklist.js') }}"></script>
@endpush